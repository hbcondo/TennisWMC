...
set CompanyName=Tennis for Windows Media Center
set AssemblyName=TennisWMC
...
:register
    ...
    copy /y ".\Setup\%RegistrationName%.xml" "%ProgramFilesPath%\%CompanyName%\"
    ...
    "%GACUtilPath%\Microsoft SDKs\Windows\v6.0A\bin\gacutil.exe" /if "%ProgramFilesPath%\%CompanyName%\%AssemblyName%.dll"
